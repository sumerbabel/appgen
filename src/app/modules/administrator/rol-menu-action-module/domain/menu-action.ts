...
export class MenuAction extends formModel implements DataModel {
  public _id: string;
  ...
  static createMenu(object: Object): MenuAction {
    let menu: MenuAction = new MenuAction(
      object['id'],
      object['id_sistem'],
      object['id_module'],
      object['name'],
  ...
  static createMenuEmpty(idSistem: string, idModule): MenuAction {
    let menu: MenuAction = new MenuAction(
      MenuAction.generateUuid(),
      idSistem,
      idModule,
      undefined,
      undefined,
