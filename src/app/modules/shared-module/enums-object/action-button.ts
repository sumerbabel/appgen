...
export class ActionButton {
    ...
    public static CLOSE = { name: 'Cerrar',tooltip:'Cerrar', action: ActionGeneric.CLOSE, icon:Icons.CLOSE, color: '', colorText: '', styleClass: StyleButtonEnum.MINIM, isVisible: true }
