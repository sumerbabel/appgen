...
export class ActionButton {
    ...
    public static MINI_FILTER = { name: '',tooltip:'Filtros', action: ActionGeneric.OPEN, icon: Icons.FILTER, color: Colors.BLUE_GRADIENT_METAL, colorText: Colors.WHITE, styleClass: [StyleButtonEnum.MINIM], isVisible: true }
    public static MINI_CLEAR = { name: '',tooltip:'Limpiar', action: ActionGeneric.CLEAR, icon: Icons.CLEAR, color: Colors.BLUE_GRADIENT_METAL, colorText: Colors.WHITE, styleClass: [StyleButtonEnum.MINIM], isVisible: true }
    public static MINI_DOCUMENT = { name: '',tooltip:'Documentos', action: ActionGeneric.EXECUTE, icon: Icons.COPY, color: Colors.BLUE_GRADIENT_METAL, colorText: Colors.WHITE, styleClass: [StyleButtonEnum.MINIM], isVisible: true }
    public static MINI_SEARCH = { name: '',tooltip:'Buscar', action: ActionGeneric.EXECUTE, icon: Icons.SEARCH, color: Colors.BLUE_GRADIENT_METAL, colorText: Colors.WHITE, styleClass: [StyleButtonEnum.MINIM], isVisible: true }
    public static MINI_EXPORT = { name: '',tooltip:'Exportar datos en excel', action: ActionGeneric.EXECUTE, icon: Icons.EXCEL_FILE, color: Colors.BLUE_GRADIENT_METAL, colorText: Colors.WHITE, styleClass: [StyleButtonEnum.MINIM], isVisible: true }


    public static CLEAR = { name: 'Limpiar',tooltip:'Limpiar Filtros', action: ActionGeneric.CLEAR, icon: Icons.CLEAR, color: Colors.BLUE_GRADIENT_METAL, colorText: Colors.WHITE, styleClass: [StyleButtonEnum.DEFAULT], isVisible: true }
    ...
    public static CREATE= { name: 'Nuevo Registro',tooltip:'Crear Registro', action: ActionGeneric.CREATE, icon:Icons.STAR, color: Colors.ORANGE, colorText: Colors.WHITE, styleClass: [StyleButtonEnum.DEFAULT], isVisible: true }
